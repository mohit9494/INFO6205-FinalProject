...
import static edu.neu.coe.info6205.util.SortUtils.getPinYinString;
...
//        return stringToBytesToLong(str, MAX_LENGTH_UNICODE, StandardCharsets.UTF_16, startingPos) >>> 1;
    ...
    private static long stringToLong(final String s, final int maxLength, final int bitWidth, final int mask) {
        String str  = getPinYinString(s);
